    ...
    <div>
        ...
        <div className="container-flex">
                <div className="text-center">
                    <h1 className="heading-text">Trips Manager</h1>
                </div>
                </div>

                <Container>
                <Table striped bordered hover responsive variant="dark" className="table-sm table-bg content-text">
            <thead>
                <tr>
                    <th className='content-text'>ID</th>
                    <th className='content-text'>Name</th>
                    <th className='content-text'>Price</th>
                    <th></th>
                    <th></th>
                </tr>
            </thead>
